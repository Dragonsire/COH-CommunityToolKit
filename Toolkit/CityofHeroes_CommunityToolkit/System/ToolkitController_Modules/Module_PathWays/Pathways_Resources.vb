...
#Region "Retrieve Resource"
        ...
        Public Function RetrieveResource_FormSkin(Entry As DS_PathwaysCollectionEntry) ' As WindowFormsConfiguration_Skin
            ...
            Dim SkinResult As FormsConfiguration_FormSkin = FormsConfiguration_FormSkin.LoadTheme_FromFolder(FolderPath)
            Return SkinResult
        End Function
        Public Function RetrieveResource_FormSkin_Default() As FormsConfiguration_FormSkin
