Namespace Controls
    Public NotInheritable Class FormSkinRegion_TitleBar
        Inherits FormSkinRegion

#Region "Properties"
        Public Enum CurrentTitleBarState
            None = 0
            Normal
            Pressed
            Disabled
        ...
        Public Property ButtonState_Pressed As Image
            ...
            End Set
        End Property
        Public ReadOnly Property CurrentState As CurrentTitleBarState
            Get
                Return pCurrentState
            End Get
        End Property
        Private pCurrentState As CurrentTitleBarState
...
#Region "Create New Instance"
        ...
        Public Overrides Sub ResetToDefault()
            '///ALL HERE
            pCurrentState = CurrentTitleBarState.None
...
#Region "Retrieve Appropriate Image"
        Public Function RetrieveImage_FromButtonState(Enabled As Boolean, SelectedState As CurrentTitleBarState) As Image
            Select Case SelectedState
                Case CurrentTitleBarState.None
                    If Enabled = False Then
                        Return ButtonState_Disabled
                    Else
                        Return ButtonState_Normal
                    End If
                Case CurrentTitleBarState.Disabled
                    Return ButtonState_Disabled
                Case CurrentTitleBarState.Normal
                    Return ButtonState_Normal
                Case CurrentTitleBarState.Pressed
