Namespace Controls.Configuration
    Partial Public Class WindowFormsConfiguration_ColorScheme

        Public Sub ApplyColorScheme(ByRef SourceForm As Form)
            ApplyColorScheme(Me, SourceForm)
        End Sub
        Public Shared Sub ApplyColorScheme(ByRef ColorScheme As WindowFormsConfiguration_ColorScheme, ByRef SourceForm As Form)
            SourceForm.BackColor = ColorScheme.Form_Background.Color
            ApplyColorScheme_ToControls(ColorScheme, SourceForm)
        End Sub
        Private Shared Sub ApplyColorScheme_ToControls(ByRef ColorScheme As WindowFormsConfiguration_ColorScheme, ByRef SourceControl As Control)
            ...
            Next
        End Sub
        Private Shared Sub ApplyColorScheme_ToControl(ByRef ColorScheme As WindowFormsConfiguration_ColorScheme, ByRef SourceControl As Control)
...
#Region "Individual Controls"
        Private Shared Sub ApplyColorScheme_ToControl_TabControl(ByRef ColorScheme As WindowFormsConfiguration_ColorScheme, ByRef SourceControl As TabControl)
