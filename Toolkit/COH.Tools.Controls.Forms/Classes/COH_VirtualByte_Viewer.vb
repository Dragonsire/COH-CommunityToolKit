...
#Region "Virtualization"
    ...
    Private Sub RetrieveCell(e As DataGridViewCellValueEventArgs)
        ...
        Select Case mConfiguration.DataView
            Case BytesView.Bits
                e.Value = GameContent.HelperFunctions.Bits.Convert_ToString(TheByte)
            Case BytesView.Bytes
                e.Value = TheByte
            Case BytesView.Hex
...
#Region "Shared Function"
    ...
    Public Function Export_ToFile(FilePath As String) As Boolean
        If mIsCached = False Then
            ...
            Dim ExportResult As Boolean = GameContent.HelperFunctions.Bytes.Write_BytesToFile(mCurrentReader.BaseStream, FilePath)
            mCurrentReader.Position = Pos
            Return ExportResult
        Else
            Return GameContent.HelperFunctions.Bytes.Write_BytesToFile(mRawbytes, FilePath)
        End If
    End Function
#End Region
