...
#Region "Properties"
    Protected Property Current_Content As Modding.COH_ModableContent
        Get
            Return mModDetails
        End Get
        Set(value As Modding.COH_ModableContent)
            mModDetails = value
        End Set
    End Property
...
#Region "Buttons"
    ...
    Private Sub ExportCurrentAsXMLToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExportCurrentAsXMLToolStripMenuItem.Click
        ...
        If COH.Toolkit.Controls.WinForms.HelperFunctions.General.LocateFilePath("Export XML", "XML File|*.XML", ExportFilePath) = False Then Exit Sub
    ...
    Private Sub ExportCurrentAsDEFToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExportCurrentAsDEFToolStripMenuItem.Click
        ...
        If COH.Toolkit.Controls.WinForms.HelperFunctions.General.LocateFilePath("Export DEF", "DEF File|*.DEF", ExportFilePath) = False Then Exit Sub
