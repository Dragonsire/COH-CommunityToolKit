...
#Region "Properties - Storage"
		...
		''' </summary>
		''' <returns></returns>
		Public ReadOnly Property SQL_Account As asql_account
			Get
				Return pSQL_Account
			End Get
		End Property
		...
		''' </summary>
		''' <returns></returns>
		Public ReadOnly Property AccountShard As AccountServerShard
			Get
...
#Region "Private"
		...
		Private pSQL_Account As asql_account
		Private pAccountShard As AccountServerShard
