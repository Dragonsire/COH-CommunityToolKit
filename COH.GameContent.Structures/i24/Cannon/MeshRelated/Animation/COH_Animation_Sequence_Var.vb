Namespace Animation
    Public NotInheritable Class COH_Animation_Sequence_Var
...
#Region "Clone"
        Public Function Clone() As COH_Animation_Sequence_Var
            Dim Result As COH_Animation_Sequence_Var = New COH_Animation_Sequence_Var
