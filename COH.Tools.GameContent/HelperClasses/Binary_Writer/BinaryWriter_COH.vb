...
#Region "Structures"
        Public Function Write_CrypticS_StructArray_SingleItem(ByRef Source As COH_Struct, Optional Version As Integer = 0) As Boolean
            Dim Sources As COH_Struct() = New COH_Struct(0) {}
            Sources(0) = Source
            Return Write_CrypticS_StructArray(Sources, Version)
        End Function
        Public Function Write_CrypticS_StructArray(ByRef Sources As COH_Struct(), Optional Version As Integer = 0) As Boolean
            ...
            For x = 0 To Sources.Count - 1
                Dim X2 As COH_Struct = Sources(x)
                Write_CrypticS_Struct(X2)
            Next x
            Return True
        End Function
        Public Function Write_CrypticS_Struct(ByRef Source As COH_Struct, Optional Version As Integer = 0) As Boolean
