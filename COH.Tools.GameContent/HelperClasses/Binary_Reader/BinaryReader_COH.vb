...
#Region "Values"
        ...
        Public Function Read_CrypticS_Matrix4() As HelperClasses.Matrix4
            Dim VectorBytes As Vector3() = New Vector3(3) {Read_CrypticS_Vector3(), Read_CrypticS_Vector3(), Read_CrypticS_Vector3(), Read_CrypticS_Vector3()}
...
#Region "Structures"
        Public Function Read_CrypticS_StructArray_FirstItem(TheType As Type, ByRef Result As COH_Struct) As Boolean
        ...
        Public Function Read_CrypticS_StructArray(TheType As Type, ByRef Result As Object) As Boolean
            ...
            Return True
        End Function
        Public Function Read_CrypticS_Struct(TheType As Type, ByRef Result As COH_Struct) As Boolean
            '// mOptions.Option_Version = Version
            Dim NumBytes As Integer = ReadInt32()
            Dim NewItem As COH_Struct = Activator.CreateInstance(TheType)
