Namespace Internal.Attributes
    Public Class COH_Struct_ExpandableObjectCoverter
...
#End Region
        ...
        Public Overrides Function GetProperties(context As ITypeDescriptorContext, value As Object, attributes() As Attribute) As PropertyDescriptorCollection
            If TypeOf value Is GameContent.Structures.COH_Struct Then
                Dim Source As GameContent.Structures.COH_Struct = TryCast(value, GameContent.Structures.COH_Struct)
