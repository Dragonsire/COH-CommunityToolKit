...
#Region "Private Properties"
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mIdentifier As String
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mName As String
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mEntries As List(Of COH_CrypticS_FileEntry)
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mParseVersionUsed As COH_Supported_CrypticS_ParseVersion
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mBuild As COH_BuildType
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mAdler32CheckSum As Integer ' Should Be CheckSum
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mFiles As List(Of COH_CrypticS_File)
    '//Options
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private mSettings As COH_CrypticS_Settings
    '//Not Implemented Yet
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Friend mMasterList As List(Of COH_CrypticS_FileEntry)
    <EditorBrowsable(COH_DeveloperMode_ShowPrivate)> Private rFileStructs As COH_FileStructureIndex_Controller
#End Region
