...
#Region "Properties"
        <Xml.Serialization.XmlAttribute> Property Index As Int32
            Get
                Return mIndex
            End Get
            Set(value As Int32)
...
#Region "Clone"
        Public Function Clone() As COH_Generic_IndexList_Item
            Dim Result As COH_Generic_IndexList_Item = New COH_Generic_IndexList_Item
