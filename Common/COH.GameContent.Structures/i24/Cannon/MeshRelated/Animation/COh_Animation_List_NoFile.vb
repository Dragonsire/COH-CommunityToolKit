Namespace Animation
    Public NotInheritable Class COH_Animation_List_NoContent
...
#Region "Clone"
        Public Function Clone() As COH_Animation_List_NoContent
            Dim Result As COH_Animation_List_NoContent = New COH_Animation_List_NoContent
