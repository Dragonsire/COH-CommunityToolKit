...
#Region "Private Properties"
        Public ReadOnly Property Settings As COH_Serialization_Settings
            ...
            End Get
        End Property
        Private mStringBuilder As Text.StringBuilder
...
#Region "Create New Instance"
        Sub New()
            Me.New(New COH_Serialization_Settings(True, COH_ExportFormat.CrypticS_TextFormat))
        End Sub
...
#Region "Serialize"
        Public Function Serialize_ToDEF(ByRef Source As Structures.COH_FileStructure) As String
        ...
        Private Sub Write_Property(ByRef CurrentWriter As StringBuilder, ByRef Source As Object, ByRef SingleProperty As PropertyDescriptor, IsAttribute As Boolean, ByVal Padding As Integer)
            ...
            Else
                ...
                Select Case TheTypeCode
                    Case TypeCode.Object
                        If HelperFunctions.Interfaces.Determine_ImplementsInterface(SingleProperty.PropertyType, GetType(ISupport_COH_TOK_String)) = True Then
                            Write_Property_TOKString(CurrentWriter, Source, SingleProperty, Padding)
                        ElseIf HelperFunctions.Interfaces.Determine_ImplementsInterface(SingleProperty.PropertyType, GetType(ISupport_COH_TOK_StringArray)) = True Then
...
#Region "Write Other"
        Private Sub Write_Property_Other(ByRef CurrentWriter As StringBuilder, ByRef Source As Structures.COH_FileStructure, ByRef SingleProperty As PropertyDescriptor, TheTypeCode As TypeCode, IsAttribute As Boolean)
            Dim TheValue As Object = SingleProperty.GetValue(Source)
            Dim DefaultValue As Object = Retrieve_DefaultValue(Source, SingleProperty)
            Dim PropertyName As String = SingleProperty.Name
